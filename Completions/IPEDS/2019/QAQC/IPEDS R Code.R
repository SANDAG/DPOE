...
source_2011 <- read.csv("R:\\DPOE\\IPEDS\\2019\\Source\\c2011_a_rv.csv", header=TRUE, sep=",", stringsAsFactors = FALSE)
source_2012 <- read.csv("R:\\DPOE\\IPEDS\\2019\\Source\\c2012_a_rv.csv", header=TRUE, sep=",", stringsAsFactors = FALSE)
source_2013 <- read.csv("R:\\DPOE\\IPEDS\\2019\\Source\\c2013_a_rv.csv", header=TRUE, sep=",", stringsAsFactors = FALSE)
source_2014 <- read.csv("R:\\DPOE\\IPEDS\\2019\\Source\\c2014_a_rv.csv", header=TRUE, sep=",", stringsAsFactors = FALSE)
source_2015 <- read.csv("R:\\DPOE\\IPEDS\\2019\\Source\\c2015_a_rv.csv", header=TRUE, sep=",", stringsAsFactors = FALSE)
source_2016 <- read.csv("R:\\DPOE\\IPEDS\\2019\\Source\\c2016_a_rv.csv", header=TRUE, sep=",", stringsAsFactors = FALSE)
source_2017 <- read.csv("R:\\DPOE\\IPEDS\\2019\\Source\\c2017_a.csv", header=TRUE, sep=",", stringsAsFactors = FALSE)
source_2018 <- read.csv("R:\\DPOE\\IPEDS\\2019\\Source\\c2018_a.csv", header=TRUE, sep=",", stringsAsFactors = FALSE)

#Read in SQL data 
channel <- odbcDriverConnect('driver={SQL Server}; server=socioeca8; database=dpoe_stage; trusted_connection=true')
sql_2010 <- 'SELECT * FROM dpoe_stage.dbo.c2010_a_rv'
sql_2011 <- 'SELECT * FROM dpoe_stage.dbo.c2011_a_rv'
sql_2012 <- 'SELECT * FROM dpoe_stage.dbo.c2012_a_rv'
sql_2013 <- 'SELECT * FROM dpoe_stage.dbo.c2013_a_rv'
sql_2014 <- 'SELECT * FROM dpoe_stage.dbo.c2014_a_rv'
sql_2015 <- 'SELECT * FROM dpoe_stage.dbo.c2015_a_rv'
sql_2016 <- 'SELECT * FROM dpoe_stage.dbo.c2016_a_rv'
sql_2017 <- 'SELECT * FROM dpoe_stage.dbo.c2017_a'
sql_2018 <- 'SELECT * FROM dpoe_stage.dbo.c2018_a'
db_2010 <- sqlQuery(channel,sql_2010,stringsAsFactors = FALSE)
db_2011 <- sqlQuery(channel,sql_2011,stringsAsFactors = FALSE)
db_2012 <- sqlQuery(channel,sql_2012,stringsAsFactors = FALSE)
db_2013 <- sqlQuery(channel,sql_2013,stringsAsFactors = FALSE)
db_2014 <- sqlQuery(channel,sql_2014,stringsAsFactors = FALSE)
db_2015 <- sqlQuery(channel,sql_2015,stringsAsFactors = FALSE)
db_2016 <- sqlQuery(channel,sql_2016,stringsAsFactors = FALSE)
db_2017 <- sqlQuery(channel,sql_2017,stringsAsFactors = FALSE)
db_2018 <- sqlQuery(channel,sql_2018,stringsAsFactors = FALSE)
odbcClose(channel)

#To see column names in data
# colnames(source_2010)
# colnames(db_2010)
# colnames(source_2011)
# colnames(db_2011)
# colnames(source_2012)
# colnames(db_2012)
# colnames(source_2013)
# colnames(db_2013)
...
db_2018 <- plyr::rename(db_2018, c("CNRALW  "="CNRALW"))
...
# all(colnames(source_2018) == colnames(db_2018))
...
# str(source_2018)
# str(db_2018)
# all(str(source_2018) == str(db_2018))
...
#2018
db_2018$"XC2MORM"<-gsub('"', "", db_2018$"XC2MORM")
db_2018$"XC2MORT"<-gsub('"', "", db_2018$"XC2MORT")
db_2018$"XC2MORW"<-gsub('"', "", db_2018$"XC2MORW")
db_2018$"XCAIANM"<-gsub('"', "", db_2018$"XCAIANM")
db_2018$"XCAIANT"<-gsub('"', "", db_2018$"XCAIANT")
db_2018$"XCAIANW"<-gsub('"', "", db_2018$"XCAIANW")
db_2018$"XCASIAM"<-gsub('"', "", db_2018$"XCASIAM")
db_2018$"XCASIAT"<-gsub('"', "", db_2018$"XCASIAT")
db_2018$"XCASIAW"<-gsub('"', "", db_2018$"XCASIAW")
db_2018$"XCBKAAM"<-gsub('"', "", db_2018$"XCBKAAM")
db_2018$"XCBKAAT"<-gsub('"', "", db_2018$"XCBKAAT")
db_2018$"XCBKAAW"<-gsub('"', "", db_2018$"XCBKAAW")
db_2018$"XCHISPM"<-gsub('"', "", db_2018$"XCHISPM")
db_2018$"XCHISPT"<-gsub('"', "", db_2018$"XCHISPT")
db_2018$"XCHISPW"<-gsub('"', "", db_2018$"XCHISPW")
db_2018$"XCNHPIM"<-gsub('"', "", db_2018$"XCNHPIM")
db_2018$"XCNHPIT"<-gsub('"', "", db_2018$"XCNHPIT")
db_2018$"XCNHPIW"<-gsub('"', "", db_2018$"XCNHPIW")
db_2018$"XCNRALM"<-gsub('"', "", db_2018$"XCNRALM")
db_2018$"XCNRALT"<-gsub('"', "", db_2018$"XCNRALT")
db_2018$"XCNRALW"<-gsub('"', "", db_2018$"XCNRALW")
db_2018$"XCTOTALM"<-gsub('"', "", db_2018$"XCTOTALM")
db_2018$"XCTOTALT"<-gsub('"', "", db_2018$"XCTOTALT")
db_2018$"XCTOTALW"<-gsub('"', "", db_2018$"XCTOTALW")
db_2018$"XCUNKNM"<-gsub('"', "", db_2018$"XCUNKNM")
db_2018$"XCUNKNT"<-gsub('"', "", db_2018$"XCUNKNT")
db_2018$"XCUNKNW"<-gsub('"', "", db_2018$"XCUNKNW")
db_2018$"XCWHITM"<-gsub('"', "", db_2018$"XCWHITM")
db_2018$"XCWHITT"<-gsub('"', "", db_2018$"XCWHITT")
db_2018$"XCWHITW"<-gsub('"', "", db_2018$"XCWHITW")
...
source_2018 <- source_2018[order(source_2018$"UNITID",source_2018$"CIPCODE",source_2018$"MAJORNUM",source_2018$"AWLEVEL",source_2018$"XCTOTALT",source_2018$"CTOTALT",source_2018$"XCTOTALM",source_2018$"CTOTALM",source_2018$"XCTOTALW",source_2018$"CTOTALW",source_2018$"XCAIANT",source_2018$"CAIANT",source_2018$"XCAIANM",source_2018$"CAIANM",source_2018$"XCAIANW",source_2018$"CAIANW",source_2018$"XCASIAT",source_2018$"CASIAT",source_2018$"XCASIAM",source_2018$"CASIAM",source_2018$"XCASIAW",source_2018$"CASIAW",source_2018$"XCBKAAT",source_2018$"CBKAAT",source_2018$"XCBKAAM",source_2018$"CBKAAM",source_2018$"XCBKAAW",source_2018$"CBKAAW",source_2018$"XCHISPT",source_2018$"CHISPT",source_2018$"XCHISPM",source_2018$"CHISPM",source_2018$"XCHISPW",source_2018$"CHISPW",source_2018$"XCNHPIT",source_2018$"CNHPIT",source_2018$"XCNHPIM",source_2018$"CNHPIM",source_2018$"XCNHPIW",source_2018$"CNHPIW",source_2018$"XCWHITT",source_2018$"CWHITT",source_2018$"XCWHITM",source_2018$"CWHITM",source_2018$"XCWHITW",source_2018$"CWHITW",source_2018$"XC2MORT",source_2018$"C2MORT",source_2018$"XC2MORM",source_2018$"C2MORM",source_2018$"XC2MORW",source_2018$"C2MORW",source_2018$"XCUNKNT",source_2018$"CUNKNT",source_2018$"XCUNKNM",source_2018$"CUNKNM",source_2018$"XCUNKNW",source_2018$"CUNKNW",source_2018$"XCNRALT",source_2018$"CNRALT",source_2018$"XCNRALM",source_2018$"CNRALM",source_2018$"XCNRALW",source_2018$"CNRALW"),]
...
db_2018 <- db_2018[order(db_2018$"UNITID",db_2018$"CIPCODE",db_2018$"MAJORNUM",db_2018$"AWLEVEL",db_2018$"XCTOTALT",db_2018$"CTOTALT",db_2018$"XCTOTALM",db_2018$"CTOTALM",db_2018$"XCTOTALW",db_2018$"CTOTALW",db_2018$"XCAIANT",db_2018$"CAIANT",db_2018$"XCAIANM",db_2018$"CAIANM",db_2018$"XCAIANW",db_2018$"CAIANW",db_2018$"XCASIAT",db_2018$"CASIAT",db_2018$"XCASIAM",db_2018$"CASIAM",db_2018$"XCASIAW",db_2018$"CASIAW",db_2018$"XCBKAAT",db_2018$"CBKAAT",db_2018$"XCBKAAM",db_2018$"CBKAAM",db_2018$"XCBKAAW",db_2018$"CBKAAW",db_2018$"XCHISPT",db_2018$"CHISPT",db_2018$"XCHISPM",db_2018$"CHISPM",db_2018$"XCHISPW",db_2018$"CHISPW",db_2018$"XCNHPIT",db_2018$"CNHPIT",db_2018$"XCNHPIM",db_2018$"CNHPIM",db_2018$"XCNHPIW",db_2018$"CNHPIW",db_2018$"XCWHITT",db_2018$"CWHITT",db_2018$"XCWHITM",db_2018$"CWHITM",db_2018$"XCWHITW",db_2018$"CWHITW",db_2018$"XC2MORT",db_2018$"C2MORT",db_2018$"XC2MORM",db_2018$"C2MORM",db_2018$"XC2MORW",db_2018$"C2MORW",db_2018$"XCUNKNT",db_2018$"CUNKNT",db_2018$"XCUNKNM",db_2018$"CUNKNM",db_2018$"XCUNKNW",db_2018$"CUNKNW",db_2018$"XCNRALT",db_2018$"CNRALT",db_2018$"XCNRALM",db_2018$"CNRALM",db_2018$"XCNRALW",db_2018$"CNRALW"),]
...
#2018
all(source_2018 == db_2018) #check cell values only
all.equal(source_2018,db_2018) #check cell values and data types and will return the conflicted cells
identical(source_2018,db_2018) #check cell values and data types
which(source_2018!=db_2018,arr.ind=TRUE)
...
source_2018 <- add_column(source_2018, yr=2018, .before="UNITID")
...
source_2018 <- source_2018[-c(6,8:65)]

#Merge into one file
source <- do.call("rbind", list(source_2010, source_2011, source_2012, source_2013, source_2014, source_2015, source_2016, source_2017, source_2018))

#Remove old source/db files
rm(source_2010, source_2011, source_2012, source_2013, source_2014, source_2015, source_2016, source_2017, source_2018)
rm(db_2010, db_2011, db_2012, db_2013, db_2014, db_2015, db_2016, db_2017, db_2018)
