...
#Source_data <- read.xlsx(file, sheetIndex = 9, header = TRUE) #header doesn't work
...
names(Source_data) <- c("Military Family HH Population","Military Family HH Population - Facility N/A",
                        "F3","F4","F5","F6","F7","F8","F9","F10","F11","F12")

####Obtain SQL Database Data####
#SQL data
source("R:/DPOE/DOF Group Quarters/2019/QAQC/readSQL.R")
sql_query = getSQL("R:/DPOE/DOF Group Quarters/2019/QAQC/SQL Query/staging_mil_fam_gq.sql")
