...
#Source_data <- read.xlsx(file, sheetIndex = 6, header = TRUE) #header doesn't work
...
sql_query = getSQL("R:/DPOE/DOF Group Quarters/2019/QAQC/SQL Query/staging_jail_gq.sql")
...
#Find distinct values in facility_name column
unique(fact$facility_name)
unique(Source_data$facility_name)
